...
<Note>
**Prerequisites:** The AI Assistant requires an LLM provider to be configured before use. Go to [Settings > LLM Configuration](/settings/llm-configuration) to set up your AI provider. You can also extend the AI's capabilities by connecting [MCP Servers](/settings/mcp-servers).
</Note>
