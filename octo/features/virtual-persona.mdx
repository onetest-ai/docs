...
**Layer 1 — Local knowledge (instant, no API calls):**
...
<CardGroup cols={2}>
  <Card title="Setup Guide" icon="rocket" href="/octo/guides/virtual-persona-setup">
    Step-by-step VP setup and first test
  </Card>
  <Card title="Teams Integration" icon="people-group" href="/octo/guides/teams-integration">
