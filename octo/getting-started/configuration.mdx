...
See [Voice](/features/voice) for the subprocess protocol, example scripts, and voiceover text preparation.
...
<CardGroup cols={2}>
  ...
  <Card title="Teams Integration" icon="comments" href="/octo/guides/teams-integration">
    Read and send MS Teams messages
  </Card>
  <Card title="Model Profiles" icon="sliders" href="/octo/guides/model-profiles">
    Fine-tune cost vs quality
  </Card>
  <Card title="MCP Servers" icon="plug" href="/octo/features/mcp-servers">
