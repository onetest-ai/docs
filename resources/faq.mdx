...
<AccordionGroup>
  ...
  <Accordion title="Can I import and export tests?" icon="file-import">
    **Import:** OneTest supports importing tests from:
    ...
    - **JUnit XML files** — automated results via API Integrations
  ...
  <Accordion title="How do I integrate with CI/CD?" icon="code-branch">
    OneTest provides **API Integrations** — ReportPortal-compatible API keys for CI/CD integration:
    ...
    See [API Integrations](/settings/api-integrations) for detailed setup.
  </Accordion>
</AccordionGroup>
