...
API Integrations allow external tools like **ReportPortal agents**, **JUnit reporters**, and **CI/CD pipelines** to push test results directly into OneTest. They're fully compatible with the ReportPortal v2 API.

<img src="/images/screenshots/test-agents.png" alt="API Integrations page" />

## Setting Up API Integrations

<Steps>
  <Step title="Navigate to Settings">
    Go to **Settings** > **API Integrations** from the sidebar.
  </Step>
  ...
  <Step title="Configure Your Pipeline">
    ...
    Your **Product UUID** is displayed on the API Integrations page and can be copied with one click.
  </Step>
